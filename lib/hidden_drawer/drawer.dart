        ...
        children: <Widget>[
            ...
            child: Padding(
              ...
              child: ListView(
                children: <Widget>[
                  ...
                  SizedBox(
                    height: 17.56 * SizeConfig.heightMultiplier,
                  ),
                  Column(
          ...
          Transform.scale(
            ...
            child: Transform.translate(
                offset: Offset(
                    MediaQuery.of(context).size.width * 0.58 * animation.value,
                    MediaQuery.of(context).size.height * 0.05 * animation.value),
                child: Transform.rotate(
                  angle: pi/12 * animation.value,
                  child: AbsorbPointer(
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Padding(
                          padding: EdgeInsets.only(left: animation.value * 20),
                          child: ClipRRect(
