...
class ThankYouMapReqPage extends StatefulWidget {
  final String uid;

  const ThankYouMapReqPage({Key key, this.uid}) : super(key: key);

  @override
  _ThankYouMapReqPageState createState() => _ThankYouMapReqPageState(uid);
}

class _ThankYouMapReqPageState extends State<ThankYouMapReqPage> {

 final String uid;
  ConfettiController _controllerCenter;

  _ThankYouMapReqPageState(this.uid);
            ...
            Center(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 20,),
                  Text("Thank You !!\nYour Request has been Registered",style: TextStyle(color: Color.fromARGB(
